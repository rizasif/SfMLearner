...
flags.DEFINE_string("ckpt_file", "checkpoints/model-20", "checkpoint file") #model-20.data-00000-of-00001
FLAGS = flags.FLAGS
...
def main(_):
    ...
    test_files = list()
    with open("data/test.txt", "rb") as fp:
    ...
    with tf.Session(config=config) as sess:
        ...
        for t in range(0, len(test_files), FLAGS.batch_size):
            ...
            for b in range(FLAGS.batch_size):
                ...
                # fh = open(test_files[idx], encoding='UTF-8')
